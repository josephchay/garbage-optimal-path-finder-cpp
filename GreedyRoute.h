...
//                    cout << "\n**Total time exceeds 8 hours, refer to the locations below that can be visited within 8 hours**" << endl;
    ...
    void dijkstraAlgorithm(int garbageLocationGraph[VERTICES][VERTICES], int source, const vector<string>& currentLocations, const GarbageLocations& garbageLocations, ofstream& outFileGR) { //This is the Dijkstra Algorithm method which contains the algorithm logic
        ...
        daSolution(distance, VERTICES, parentLocation, currentLocations, garbageLocations, outFileGR); //Call the daSolution method to find the solution
    }
};
